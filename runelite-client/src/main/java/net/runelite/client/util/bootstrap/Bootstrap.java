...
public class Bootstrap
{
	...
	private Artifact[] getArtifacts()
	{
		try
		{
			...
			artifacts[7].path = "https://mvn.runelite.net/net/sf/jopt-simple/jopt-simple/5.0.4/jopt-simple-5.0.4.jar";
			...
			artifacts[13].path = "https://mvn.runelite.net/com/google/inject/guice/4.2.2/guice-4.2.2-no_aop.jar";
			...
			artifacts[19].name = "commons-text-1.7.jar";
			artifacts[19].path = "https://mvn.runelite.net/org/apache/commons/commons-text/1.7/commons-text-1.7.jar";
			...
			artifacts[33].name = "jna-5.4.0.jar";
			artifacts[33].path = "https://mvn.runelite.net/net/java/dev/jna/jna/5.4.0/jna-5.4.0.jar";
			...
			artifacts[34].path = "https://mvn.runelite.net/net/java/dev/jna/jna-platform/5.4.0/jna-platform-5.4.0.jar";
			...
			artifacts[40].name = "commons-csv-1.7.jar";
			artifacts[40].path = "https://mvn.runelite.net/org/apache/commons/commons-csv/1.7/commons-csv-1.7.jar";
